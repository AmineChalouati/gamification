...
@TemplateConfigs(templates = {
        @TemplateConfig(pluginId = GamificationConstant.GAMIFICATION_EARNED_BADGE_NOTIFICATION_ID, template = "war:/conf/gamication/templates/notification/mail/GamificationEarnedBadgeMailPlugin.gtmpl")})
