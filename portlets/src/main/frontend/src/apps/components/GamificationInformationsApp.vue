...

   {
    ...
    export default {
        ...
        methods:{
            ...
            maximize() {
                window.location.href = `${eXo.env.portal.context}/${eXo.env.portal.portalName}/achievements/${eXo.env.portal.userName}`;
            ...
            initMenuApp() {
                ...
                this.$nextTick(() => {
                    ...
                    if (!$('.userNavigation.item').length) {
                        setTimeout(this.initMenuApp, 100);
                        return;
                    }
                    $('.userNavigation').append(` \
          <li id='myGamificationTab' class='item active'> \
            <a href='${eXo.env.portal.context}/${eXo.env.portal.portalName}/achievements/${eXo.env.portal.userName}'>
